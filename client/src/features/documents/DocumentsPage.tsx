...
// Single source for the type dropdowns (filter + create) so every DocumentType
// is filterable and creatable. Previously only 6 of the 13 were listed, so
// docs typed ROADMAP / INVOICE_DEPOSIT / etc. (generated by the agent-service
// and client-portal flows) couldn't be filtered or created here at all.
// Ordered roughly along a project's document lifecycle. i18n key is the
// lowercased enum value under documents.types.*.
