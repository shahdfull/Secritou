...
| 4.13 Notifications & Automatisations | `docs/n8n-events.md` (intégral, 426 lignes — catalogue des ~25 événements sortants). `server/src/jobs/**` (intégral, 8 fichiers — session 2026-07-17) | `notification.service.ts`, `email.service.ts`, `emailTemplates/**` | partiel |
