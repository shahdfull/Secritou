...
router.delete("/:id", sensitiveWriteRateLimit, authorize("ADMIN", "MANAGER"), requirePermission("tasks", "delete"), deleteTask);
...
router.post("/bulk/status", sensitiveWriteRateLimit, authorize("ADMIN", "MANAGER"), requirePermission("tasks", "update"), validate(bulkUpdateTaskStatusSchema), bulkUpdateTaskStatus);
router.post("/bulk/delete", sensitiveWriteRateLimit, authorize("ADMIN", "MANAGER"), requirePermission("tasks", "delete"), validate(bulkDeleteTasksSchema), bulkDeleteTasks);
...
router.post("/:taskId/comments", sensitiveWriteRateLimit, authorize("ADMIN", "MANAGER", "FREELANCER"), validate(addTaskCommentSchema), createComment);
router.put("/:taskId/comments/:commentId", sensitiveWriteRateLimit, authorize("ADMIN", "MANAGER", "FREELANCER"), validate(updateTaskCommentSchema), updateComment);
router.delete("/:taskId/comments/:commentId", sensitiveWriteRateLimit, authorize("ADMIN", "MANAGER", "FREELANCER"), validate(deleteTaskCommentSchema), deleteComment);
...
router.post("/:taskId/checklist", sensitiveWriteRateLimit, authorize("ADMIN", "MANAGER", "FREELANCER"), validate(createChecklistItemSchema), createChecklistItem);
router.put("/:taskId/checklist/:itemId", sensitiveWriteRateLimit, authorize("ADMIN", "MANAGER", "FREELANCER"), validate(updateChecklistItemSchema), updateChecklistItem);
router.delete("/:taskId/checklist/:itemId", sensitiveWriteRateLimit, authorize("ADMIN", "MANAGER", "FREELANCER"), validate(deleteChecklistItemSchema), deleteChecklistItem);
