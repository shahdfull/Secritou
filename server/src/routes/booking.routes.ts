...
router.post("/admin/slots", authenticate, authorize("ADMIN"), validate(createAvailabilitySlotSchema), createSlot);
router.post("/admin/slots/recurring", authenticate, authorize("ADMIN"), validate(createRecurringAvailabilitySchema), createRecurringSlots);
router.delete("/admin/slots/:id", authenticate, authorize("ADMIN"), validate(bookingIdParamSchema), deleteSlot);
router.get("/admin/bookings", authenticate, authorize("ADMIN"), listBookings);
router.patch("/admin/bookings/:id/cancel", authenticate, authorize("ADMIN"), validate(bookingIdParamSchema), cancelBooking);
