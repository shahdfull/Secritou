...
ouverte (session du 2026-07-19, `ouvert`)** : absence de 6
...
vs concurrent PM généraliste), pas un défaut. Reprise partielle décidée
par le porteur : 4 des 6 items retenus (pièces jointes, mentions @,
actions en masse, sous-tâches), chacun recevant son propre ID à son
traitement (relié à SEC-060 par `classe`, jamais fusionné). **SEC-064
...
`MentionTextarea.test.tsx`, 3 cas client). `verifie: test`. Voir
SEC-059, SEC-060, SEC-063, SEC-064, SEC-065.
