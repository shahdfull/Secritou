...
**SEC-056 ouverte (session du 2026-07-19, `ouvert`)** :
`TasksListView.tsx` n'offre qu'un filtre statut + recherche (manquent
projet/assigné/échéance) et utilise une grille CSS à colonnes fixes
sans variante mobile, contrairement à la grille responsive de
`ProjectsPage.tsx`. Non corrigée cette session. Voir SEC-056.
